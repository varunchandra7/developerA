...
exports.HerbModel = void 0;
const types_1 = require("@shared/types");
const mongoose_1 = require("mongoose");
const referenceSchema = new mongoose_1.Schema({
    type: {
        type: String,
        enum: Object.values(types_1.ReferenceType),
        required: true,
    },
    title: {
        type: String,
...
const herbSchema = new mongoose_1.Schema({
    name: {
        sanskrit: {
            type: String,
            required: true,
...
exports.HerbModel = (0, mongoose_1.model)('Herb', herbSchema);
